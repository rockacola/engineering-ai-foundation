...
These rules apply regardless of language. Language-specific rules belong in additional files in this directory.
...
Language-specific elaborations of these rules belong in additional files in this directory.
